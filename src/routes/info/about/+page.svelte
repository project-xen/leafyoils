<div class="p-6 xl:px-0 w-full lg:max-w-5xl mx-auto mt-12 mb-40 md:px-12">
  <h1 class="text-3xl lg:text-5xl font-bold border-b border-gray-400 pb-4">
    About Us
  </h1>

  <div class="lg:flex justify-between items-start gap-12 py-8">
    <div class="flex items-center lg:w-1/4 mb-8">
      <img src="/logo.png" alt="site logo" class="block w-24 lg:w-32 -ml-4" />
      <div class="text-4xl lg:text-5xl font-semibold tracking-wide -ml-4">
        <span class="text-green-400">Leafy</span> <br /> Oils
      </div>
    </div>
